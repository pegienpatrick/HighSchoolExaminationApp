...
import static com.pegien.HighSchoolExamination.BusinessLogic.TimeTable.TimeTableUtils.*;

public class TeachersTimeTableUtils {

    public static void printTeacherTimeTable() {
        try{
...
//                document.add(new Paragraph(teachersName.get(teacher)));
                ...
                Paragraph phrase= new Paragraph("Teacher : "+teachersName.get(teacher),headFont);
...
//                    teacherTable.addCell(dayNames[day]);
                    ...
                    TimeTableLesson[] allLessons=teachersTimeTables.get(teacher).get(day);
