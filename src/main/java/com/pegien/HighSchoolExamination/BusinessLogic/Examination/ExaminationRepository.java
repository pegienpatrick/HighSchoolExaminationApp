...
public interface ExaminationRepository extends JpaRepository<Examination,Long> {
    ...
    @Query("select new com.pegien.HighSchoolExamination.Examination.models.responses.Term(e.year,e.term) from Examination e where e.deleted=false  group by e.year,e.term order By e.year,e.term desc")
    List<Term> listTerms();
