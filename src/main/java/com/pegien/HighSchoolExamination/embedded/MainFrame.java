...
package com.pegien.HighSchoolExamination.embedded;
...
//        clie/nt_.addLoadHandler()
    ...
    private JPanel navigation() {
        ...
        home.addActionListener((e)->{
            browser_.loadURL("localhost:8080");
        });
...
//            browser_.reloadIgnoreCache();
        ...
        JButton forceReload=new JButton("Hard Reload");
        container.add(forceReload);

        forceReload.addActionListener((e)->{
            browser_.reloadIgnoreCache();
//            browser_.reload();
        });
